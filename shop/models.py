...
class Contact(models.Model):
    ...
    surname = models.CharField(max_length=30,null=False,blank=False,verbose_name="Soyisim")
    email = models.EmailField(verbose_name="Email")
    subject = models.CharField(max_length=200,null=False,blank=False,verbose_name="Konu")
    message = models.TextField(verbose_name="Mesaj")

    def __str__(self):
        return f"{self.name} {self.surname} | {self.email} | {self.subject}"
